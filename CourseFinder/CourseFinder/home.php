...
<body class="d-flex flex-column min-vh-100">
    ...
    else
    {
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="alert alert-primary" style="width: 300px;margin-top: 35px;" role="alert">
    ...
    <div class="container" class="container">
        <div class="row">
            ...
            <div class="col" class="home">
                <div class="home">
                <a href="search.php"><h3>Save Courses</h3></a><br>
                    <p>Save courses which you are interested in!</p>
                    <br><br><br>
                </div>
            </div>
